        ...
        {generatedExpenses.length === 0 ? (
          ...
          <View style={styles.generatedList}>
            {generatedExpenses.map((expense) => (
              <Surface key={expense.id} style={[styles.generatedCard, !expense.selected && styles.generatedCardMuted]}>
      ...
      <Surface style={styles.panel}>
        <View style={styles.reviewHeader}>
          <View>
            ...
            <Text style={styles.reviewSub}>
              These are task imports from the same scan. Bank-based tasks are saved as essential by default.
            </Text>
          </View>
